...
* -s    Streams the audio from the given url to mpv.
* -o    Outputs the title and url of the audio.
* -d    Downloads the audio to the given file and streams the audio as it is downloading.
## License
